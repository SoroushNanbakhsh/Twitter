package org.example.Client.Terminal;
...
public class Menu {
    ...
    public static String[] printSignupPage() {
        ...
        } while (!UserController.userPasswordChecker(userDetails[1]));
        ...
        } while (!UserController.userEmailChecker(userDetails[4]));

        do {
            System.out.print("                    Phone number: ");
            userDetails[5] = scanner.nextLine();
        } while (!UserController.userPhoneNumberChecker(userDetails[5]));
    ...
    public static void showLatestTweet(User user) {
        ...
        if(textMessage instanceof PhotoMessage) {
            System.out.println(((PhotoMessage) textMessage).getFile());
        }
    ...
    public static TextMessage addTweet() {
        ...
        do {
            ...
            if (choice == 1) {
                ...
                return new PhotoMessage(text, file);
