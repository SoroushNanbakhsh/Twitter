...
import org.example.Client.Utils.FollowDetails;
        ...
        int i = 1;
         for(User elementUser : newTweets.keySet()) {
             ...
             if(choice == 1) {
                 ...
                 TextMessage textMessage = new TextMessage(Menu.replyOption());
                 ...
                 Login.user.addRetweets(elementUser ,newTweets.get(elementUser));
                 newTweets.get(elementUser).addQuote(Login.user, new TextMessage(Menu.newQuote()));
                 Menu.actionWasSuccessful();
         ...
         for(TextMessage elementTextMessage : favstars.keySet()) {
             ...
             if(choice == 1) {
                 ...
                 Login.user.addRetweets(favstars.get(elementTextMessage) ,elementTextMessage);
                 newTweets.get(favstars.get(elementTextMessage)).addQuote(Login.user, new TextMessage(Menu.newQuote()));
                 Menu.actionWasSuccessful();
